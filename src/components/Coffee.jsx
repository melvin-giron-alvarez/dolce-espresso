...
import { coffeeIMG } from '../constants';
...
const Coffee = () => {
  ...
  return (
    <div id='coffee' className='w-[90%] mx-auto pt-[5em] md:pt-[6em] pb-[2em]'>
        ...
        <div className='w-[80%] sm:w-[90%] text-white flex flex-wrap justify-between mx-auto'>
            {coffeeIMG.map((item, index) => (
                <div data-aos='fade-up' key={item.id} className={`sm:w-[45%] md:w-[30%] py-[1.5em]`}>
